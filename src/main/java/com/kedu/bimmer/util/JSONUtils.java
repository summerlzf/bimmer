...
//    public static final String DEFAULT_DATE_PATTERN = "yyyy-MM-dd HH:mm:ss SSS";
    ...
    public static String toJson(Object target, Type targetType,boolean isSerializeNulls, Double version, String datePattern,  
            boolean excludesFieldsWithoutExpose,boolean disableHtmlEscap) {  
        if (target == null)  
            return EMPTY_JSON;  
        ...
        if (CommonUtil.isBlank(datePattern))
    ...
    public static String toJson(Object target) {  
        return toJson(target, null, false, null, null, false,false);  
    }  
     ...
     */  
    public static String toJson(Object target, Type targetType,  
            boolean excludesFieldsWithoutExpose,String datePattern) {  
//        return toJson(target, targetType, false, null, datePattern,  
//                excludesFieldsWithoutExpose);  
        return toJson(target, targetType, true, null, datePattern,  
                excludesFieldsWithoutExpose,false);  
    }  
    ...
    public static String toJson(Object target, Type targetType,  
            boolean excludesFieldsWithoutExpose) {  
        return toJson(target, targetType, true, null, null,  
                excludesFieldsWithoutExpose,false);  
    }  
    ...
    public static String toJson(Object target, Type targetType,  
            boolean excludesFieldsWithoutExpose,boolean disableHtmlEscap) {  
        return toJson(target, targetType, true, null, null,  
                excludesFieldsWithoutExpose,disableHtmlEscap);  
    }  
    /** 
     * 将给定的目标对象转换成 {@code JSON} 格式的字符串。<strong>此方法通常用来转换使用泛型的对象。</strong> 
     * <ul> 
